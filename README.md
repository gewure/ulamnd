...
| IV | The second spectrum: the pieces oscillate at the even Maass parameters of SL₂(Z) with Katok–Sarnak amplitudes; a spectral argument for u = 1; uniformity in u as the open problem | 23 pp. The u = 1 theorem had a proof gap (found by the external assessment) and was **repaired on 13 Sep** by passing to the groups Γ₀(e), e \| rad(2D); correction notice in the paper; not yet read externally |
