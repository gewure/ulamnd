# followup/ — paper II: zeros of Dedekind zeta functions in the second moment of prime values

Scaffold created 9 September 2026. Builds on `../paper/main.tex` (paper I, v6).
...
| `scripts/riesz-raw.ts` | raw Riesz means of the diagonal of t²+1 on a log grid (`npx tsx followup/scripts/riesz-raw.ts [X]`) |
