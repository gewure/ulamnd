...
structure and the main terms but not yet the bound on the remainder (Remark~\ref{rem:gaps}): the root pairs are Heegner points, the piece is a
...
terms; the bound on its remainder is open. Record: \texttt{research/ERRATA.md}, items~13, 16 and~17.}}
...
at $8.95$, the first even newform of level $2$. We have not written that proof out and do not state it as a theorem.
\end{remark}
