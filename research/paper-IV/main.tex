...
not resolved over the lower half). Two independent forms, every constant. This is the first amplitude prediction of
this paper that the data confirm; the amplitude law for the Riesz object in \S\ref{sec:numerics} remains unconfirmed,
for the reason given in Remark~\ref{rem:gaps}.
