...
$2|D|^{-1/4}|\mathrm{Per}(u_1)\tilde L_1|\,|\Gamma(-it_1)W_c(\tfrac32+it_1)|=0.0600$ against the observed $0.0569$, a ratio
of $0.95$ (\texttt{scripts/smooth-amplitude-test.py}; the fitted amplitude carries the uncertainty of a least-squares
fit over $Y\le2\cdot10^6$ in the presence of the other lines). This is the first amplitude prediction of this paper
that the data confirm; the amplitude law for the Riesz object in \S\ref{sec:numerics} remains unconfirmed, for the
reason given in Remark~\ref{rem:gaps}.
