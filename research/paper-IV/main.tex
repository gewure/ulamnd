...
square-integrable on the finite-volume $\Gamma_0(e)\backslash\mathbb H$.
\end{proof}
...
it. So for $\Im\gamma w$ in a dyadic block $[y_0,2y_0]$ with $Yy_0<\sqrt{|D|}$ the coset count in the proof of
Lemma~\ref{lem:trunc}, with $Y$ in place of $t$, bounds the block by $\ll y_0^{1/2}+Yy_0$, and the blocks with
