...
middle column of $G$, so $G^{-1}P=(u+1)e_2$ and $P^{\mathsf T}G^{-1}L=(u+1)/u$, whence $r=\sqrt u\,(u+1)/(u\cdot u(u+1))=u^{-3/2}$. The first version of this draft stated the asymptotic as
...
(\texttt{research/explore/}, \texttt{hecke-oldform-predict.py}, \texttt{hecke-classwise.py}, \texttt{hecke-newform-u3.py}, \texttt{hecke-ratio-sharp.py}).
...
\begin{enumerate}
\item A proof of the inert identity $r=u^{-3/2}$ that explains it rather than verifies it; and closed forms for the
