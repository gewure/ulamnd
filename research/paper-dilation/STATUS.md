...
- Theorem 3 (newform lines; vanishing for inert u, and — added 15 Sep — for Fricke sign ε = −1 whatever the splitting,
...
- Proposition prop:mult (15 Sep, 12:30; generalised 15 Sep): for EVERY squarefree u, r(u;D) = r(u_e;D)·Π_{p | u/u_e} r(p;D), u_e the
...
- Remark components (15 Sep): piece u = w̄·S^w_1(uY) (the u = 1 object at length uY) + a level-u marginal part + a genuinely
...
- Data precision (15 Sep, ERRATA 35): the subtracted means carry float64 errors 1e-12–4e-11, a Y^{3/2} drift; refits move the
...
uniform in u (the conjecture of part III itself). This draft had one outside reading on 15 Sep (a fresh model instance given the files) and was read on 15 and 15 Sep by the author's
...
- 15 Sep, second pass of the reviewing conversation (five items, all checked; ERRATA 36): (1) the abstract's multiplicativity lacked
