...
\interview{1}{Background: role, training, level of mathematics before the project (last formal course; what you
could and could not read in a number-theory paper on 8 September), prior experience with LLMs in engineering work,
and what triggered the project (the Ulam spiral? something read?).}
