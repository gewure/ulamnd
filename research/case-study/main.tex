...
Opus~5 for simpler tasks (the disclosure sections of the four papers name Opus~5 and should be aligned; see
ERRATA). Fresh model instances without access to the working session were used as adversarial readers
