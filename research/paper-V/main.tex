...
\todo{Also to record here: the two candidate inputs for the point itself --- an energy bound $J_6$ at $N\asymp m^{1/4}$ for composite moduli, and a level-averaged spectral bound
for the twist $\mathrm{e}(c\,r\bar d/x)$ with $x\asymp Y^{1/2}$ (a Deshouillers--Iwaniec-type large sieve at the cusp $0$), neither of which is in the literature; and the audit of
the implied constants on which the second remark depends (research/explore/PROOFS-uniform.md §31--§34).}
