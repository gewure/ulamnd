...
const OUT = FULL ? "thesis/REPORT-full.md" : "thesis/REPORT.md";
writeFileSync(FULL ? "thesis/results-full.json" : "thesis/results.json", JSON.stringify(results, (_, v) => (typeof v === "bigint" ? v.toString() : v), 1));
