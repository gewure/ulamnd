...
export default function TheoryPanel() {
  return (
    <div className="h-full overflow-auto p-6 prose">
      ...
      <p>
        <code>npm run thesis</code> runs nine falsifiable experiments against the engine and writes <code>research/experiments/REPORT.md</code>; <code>research/experiments/CONCLUSIONS.md</code> reads them. In summary: every lattice ray is a
